...
namespace AccesoriosApp
{
    public class UserServices
    {
        ...
        public UserServices(ProtectedLocalStorage localStorage, HttpClient httpClient)
        {
            _localStorage = localStorage;
            _httpClient = httpClient;
        }

        public async Task<LoginResponse> Login(UserDTO payload)
        {
